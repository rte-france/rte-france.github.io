...
title: "GEMS"
layout: project
excerpt: "GEMS, a graph-based algebraic modelling language, to model the future of the energy system."
header:
  image: /assets/images/gems/gems_logo.webp
  teaser: /assets/images/gems/gems_logo.webp
github: https://github.com/AntaresSimulatorTeam/GEMS
license: MPL 2.0
license-url: https://www.mozilla.org/en-US/MPL/2.0/
documentation: https://gems-energy.readthedocs.io/
website: https://gems-energy.readthedocs.io/
tags: [MPL2.0]
...
![Gems_Example](/assets/images/gems/gems_Example_Model.webp){:style="display:block; margin-left:auto; margin-right:auto"}
